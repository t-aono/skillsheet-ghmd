...
| :--- | :--- |
| 業務形態 | 業務委託（フリーランス）    
| 利用技術 | frontend: Vue.js, Sass <br/> backend: Laravel, MySQL, Docker, AWS(EC2, RDS) <br/> tool: Git, GitHub 
| 担当工程 | 画面設計、実装（フロントエンド&バックエンド）、テスト          
| メンバー | エンジニア3名・PM1名    
| 内容     | 広告画像と関連情報を管理する画面の作成。<br/>要望をもとに調査やissue作成。<br/>画面表示速度の改善対応。 
...
- コミュニケーション力
    - エンジニアに転職前は営業職として働いていた経験あり。
    - 開発チーム外の方やクライアントとの打合せの経験あり。

- 提案力
    - 実装段階で気づいた使いずらい点を指摘し改善した経験あり。
