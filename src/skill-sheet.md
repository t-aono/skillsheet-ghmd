...
- 2021/5 ~ 
 	- フリーランスのエンジニアとして活動
- 2020/5 ~ 2022/3 
 	- 2年くらいWebシステムの受託開発の会社にてエンジニアとして勤務
- 2017/11 ~ 2020/4
	- 2年半くらいSES事業の会社にてエンジニアとして勤務
- 以前
 	- 5年くらい製薬メーカーにて営業職として勤務
...
| 担当工程 | 画面（UI）設計、実装
| メンバー | エンジニア5名・PM1名
| 内容 | AWSサービスを利用したサーバーレスWebアプリの開発。<br/>Google Mapの導入や画像添付メール送信などを実装。
...
| 内容     | 保護者の方や保育士の方が使う画面の作成。<br/>ユースケースごとにテーブル構造からバック、フロントエンドの実装。
...
| 担当工程 | 画面設計、実装（フロントエンド&バックエンド）、テスト          
| メンバー | エンジニア3名・PM1名    
| 内容     | 広告画像と関連情報を管理する画面の作成。<br/>要望をもとに調査やissue作成や画面表示速度の改善対応。 
...
| 担当工程 | 実装、テスト                              
| メンバー | エンジニア1名・PM1名                  
| 内容     | 小メンバーイベントの管理画面と利用者画面の一部を作成。<br/>投げ銭機能やイベント管理、ユーザー管理機能などを実装。
...
| メンバー | エンジニア1名・PM1名                            
| 内容     | 利用者用の画面、管理者用の画面のフロント&バックエンド開発。<br/>利用者が定期更新する画面や管理者が施設管理をする画面を作成。
